...
with(data2plot, plot(Time, Global_active_power, type = "l",
                   ylab = "Global Active Power", xlab = ""))

with(data2plot, plot(Time, Voltage, type = "l",
...
with(data2plot, plot(Time, Global_reactive_power, type = "l", xlab = "datetime"))
